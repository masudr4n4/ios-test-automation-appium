...
def find_java_jdk_path():
    ...
    mac_pattern = "/opt/homebrew/opt/openjdk/bin/java"
...
def create_json_capabilities():
    ...
    json_file_path = Path(__file__).parent.parent / "android_device_capabilities.json"
    with open(json_file_path, "w") as json_file:
        json.dump(device_capabilities, json_file, indent=4)
def get_ios_desired_capabilities():
    json_file_path = Path(__file__).parent.parent / "ios_device_capabilities.json"
    with open(json_file_path, "r") as json_file:
        device_capabilities = json.load(json_file)
